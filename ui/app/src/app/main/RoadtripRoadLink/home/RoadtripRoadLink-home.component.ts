...
@Component({
  selector: 'RoadtripRoadLink-home',
  templateUrl: './RoadtripRoadLink-home.component.html',
  styleUrls: ['./RoadtripRoadLink-home.component.scss']
})
export class RoadtripRoadLinkHomeComponent implements AfterViewInit {
