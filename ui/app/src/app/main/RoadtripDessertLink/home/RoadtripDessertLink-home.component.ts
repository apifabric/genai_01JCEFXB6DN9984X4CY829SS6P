...
@Component({
  selector: 'RoadtripDessertLink-home',
  templateUrl: './RoadtripDessertLink-home.component.html',
  styleUrls: ['./RoadtripDessertLink-home.component.scss']
})
export class RoadtripDessertLinkHomeComponent implements AfterViewInit {
